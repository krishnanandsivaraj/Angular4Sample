...
(function (angularApp) {
    ...
    *                      his mouse pointer.
    */
    angularApp.compileProvider.directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
     ...
     */
    angularApp.compileProvider.directive('dndList', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
                   function($parse,   $timeout,   dndDropEffectWorkaround,   dndDragTypeWorkaround) {
                       return function(scope, element, attr) {
                           ...
                           function getPlaceholderElement() {
                               ...
                               return placeholder || angular.element("<tr class='dndPlaceholder'></tr>");
                           }
     ...
     */
    angularApp.compileProvider.directive('dndNodrag', function () {
        return function(scope, element, attr) {
     ...
     */
    angularApp.compileProvider.directive('dndHandle', function () {
        return function(scope, element, attr) {
            element.attr("draggable", "true");
     ...
     */
    angularApp.provide.factory('dndDragTypeWorkaround', function () { return {} })
     ...
     */
    angularApp.provide.factory('dndDropEffectWorkaround', function () { return {} });
