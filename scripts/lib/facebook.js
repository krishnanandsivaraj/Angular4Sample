/*1461917637,,JIT Construction: v2310419,en_US*/
/**
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/XKWlIEqRSIJ.js?version=42",
                    "Flash": {
                ...
                __d('URISchemes', ['createObjectFrom'], function a(b, c, d, e, f, g, h) {
                    if (c.__markCompiled) c.__markCompiled();
                    var i = h(['blob', 'fb', 'fb-ama', 'fb-messenger', 'fb-page-messages', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp', 'whatsapp', 'moments']),
                        j = {
                ...
                __d('sdk.init', ['sdk.Cookie', 'sdk.ErrorHandling', 'sdk.Event', 'sdk.Impressions', 'Log', 'ManagedError', 'sdk.PlatformVersioning', 'QueryString', 'sdk.Runtime', 'sdk.URI', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    ...
                    function t(u) {
                       ...
                       // var v = s(u.appId || u.apiKey); Removed for string app id issue
					   var v = u.appId.toString() || u.apiKey.toString();
                    ...
                    var ha = q.extend({
                        constructor: function(ia, ja, ka, la) {
                            ...
                            this.subscribe('xd.resize.flow', ES(function(ra) {
                                ...
                                aa(this._iframeOptions.root, fa(ra.width), fa(ra.height));
                                this.updateLift();
                            ...
                            this.subscribe('xd.resize', ES(function(ra) {
                                ...
                                aa(this._iframeOptions.root, fa(ra.width), fa(ra.height));
                                aa(this._iframe, fa(ra.width), fa(ra.height));
                                this._isIframeResized = true;
                                this.updateLift();
                                clearTimeout(this._timeoutID);
                            }, 'bind', true, this));
                            this.subscribe('xd.resize.iframe', ES(function(ra) {
                                if (ra.reposition === 'true' && w('reposition_iframe', false)) this.reposition(fa(ra.width));
                                aa(this._iframe, fa(ra.width), fa(ra.height));
                                this._isIframeResized = true;
                                this.updateLift();
                                clearTimeout(this._timeoutID);
                            ...
                            var na = t.resolve('www', true) + '/plugins/' + ka + '.php?',
                                oa = {};
                            ea(this.getParams(), ia, la, oa);
                            ea(z, ia, la, oa);
                            ES('Object', 'assign', false, oa, {
                                ...
                                channel: u.handler(ES(function(ra) {
                            ...
                            this._iframeOptions = {
                                ...
                                url: na + o.encode(oa),
                                name: pa,
                                width: this._config.mobile_fullsize && r.mobile() ? void 0 : oa.width || 1000,
                            ...
                            if (this.isFluid() && oa.width !== 'auto') {
                                ...
                                if (!oa.width && this._config.full_width) {
                                    ...
                                    this._iframeOptions.url = na + o.encode(this._params);
                                }
                            }
                        },
                        process: function() {
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2310419","namespace":"FB","message":"' + e.message + '"}}');
}