(function (angularApp) {
    ...
    angularApp.compileProvider.directive('highchart', ['$timeout', function ($timeout) {
            //utility function
            ...
            var highchartsNGUtils = highchartsUtils();
            ...
            var getMergedOptions = function (scope, element, config) {
                ...
                var defaultOptions = {
                    ...
                    rangeSelector: {
                        ...
                        //inputEnabled: $('#weekly-destinations').width() > 480,
                        selected: 0
                    },
                    tooltip: {},
                    scrollbar: {
                ...
                if (config.rangeSelector) {
                    mergedOptions.rangeSelector = config.rangeSelector;
                }
                if (config.tooltip) {
